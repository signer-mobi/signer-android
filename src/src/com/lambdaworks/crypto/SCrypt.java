...
public class SCrypt {
    ...
    public static byte[] scryptJ(byte[] passwd, byte[] salt, int N, int r, int p, int dkLen) throws GeneralSecurityException {
       ...
       // Log.println(3, "alan", "scryptj2");
        Mac mac = Mac.getInstance("HmacSHA256");
       // Log.println(3, "alan", "scryptj3");
        mac.init(new SecretKeySpec(passwd, "HmacSHA256"));
       // Log.println(3, "alan", "scryptj4");
        ...
        int i;
       // Log.println(3, "alan", "scryptj5");
        PBKDF.pbkdf2(mac, salt, 1, B, p * 128 * r);
      //  Log.println(3, "alan", "scryptj6:"+p);
        for (i = 0; i < p; i++) {
            smix(B, i * 128 * r, r, N, V, XY);
       //     Log.println(3, "alan", "smix:"+i);  
        }
      //  Log.println(3, "alan", "scryptj7");
        PBKDF.pbkdf2(mac, B, 1, DK, dkLen);
      //  Log.println(3, "alan", "scryptj8");
        return DK;
    }
    ...
    public static void smix(byte[] B, int Bi, int r, int N, byte[] V, byte[] XY) {
        ...
        int Yi = 128 * r;
        int i;
        //Log.println(3, "alan", "smix1");  
        arraycopy(B, Bi, XY, Xi, 128 * r);
        //Log.println(3, "alan", "smix2");
        for (i = 0; i < N; i++) {
            arraycopy(XY, Xi, V, i * (128 * r), 128 * r);
            blockmix_salsa8(XY, Xi, Yi, r);
           // Log.println(3, "alan", "smix3:"+i);
        }
        ...
        for (i = 0; i < N; i++) {
            ...
            blockmix_salsa8(XY, Xi, Yi, r);
          //  Log.println(3, "alan", "smix4:"+i);
        }
        
        arraycopy(XY, Xi, B, Bi, 128 * r);
       // Log.println(3, "alan", "smix5");
    }
