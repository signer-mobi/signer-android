...
public class CoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(CoinSerializer.class);
     ...
     */
    public CoinSerializer(NetworkParameters params) {
     ...
     */
    public CoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
     ...
     */
    public void serialize(NetworkParameters params,String name, byte[] message, OutputStream out) throws IOException {
     ...
     * Writes message to to the output stream.
     */
    public void serialize(NetworkParameters params,Message message, OutputStream out) throws IOException {
        ...
        serialize(params,name, message.bitcoinSerialize(), out);
    }
     ...
     * {@link CoinSerializer#deserializeHeader}.
     */
