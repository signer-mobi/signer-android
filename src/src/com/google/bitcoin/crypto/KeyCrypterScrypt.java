...
public class KeyCrypterScrypt implements KeyCrypter, Serializable {
    ...
    public KeyCrypterScrypt(ByteString salt) {
    	Protos.ScryptParameters.Builder scryptParametersBuilder = Protos.ScryptParameters.newBuilder().setSalt(salt);
        this.scryptParameters = scryptParametersBuilder.build();
    }
